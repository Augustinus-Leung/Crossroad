...
public class PasswordVisibilityEditText extends EditText {
    //切换drawable的引用
    ...
    private void init() {
        ...
        if (visibilityDrawable == null) {
            visibilityDrawable = getResources().getDrawable(R.mipmap.not_visual_password);
        }
    }
        ...
        if (action == MotionEvent.ACTION_UP) {
            ...
            if (getCompoundDrawables()[2] != null) {
                ...
                if (xFlag) {
                    ...
                    if (visibililty) {
                        visibilityDrawable = getResources().getDrawable(R.mipmap.visual_password);
