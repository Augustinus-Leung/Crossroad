package com.kaiback.crossroad.chatting;
...
import com.kaiback.crossroad.util.IdHelper;
...
public class DropDownListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void initDropDownStyle() {
        ...
        headerLayout = (RelativeLayout) inflater.inflate(R.layout.jmui_drop_down_list_header,
                this, false);
        headerProgressBar = (ProgressBar) headerLayout.findViewById(R.id.jmui_drop_down_list_header_progress_bar);
        addHeaderView(headerLayout);
